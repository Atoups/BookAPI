...
// Each routed method returns a 200 (OK) or 400 (Client Error) response based on validation of the request and parameters, and whether it succeeds or fails.
...
var b3 = models.Book{Id: bson.NewObjectId(), Title: "Book Title3", Author: "An Author3", Publisher: "A Publisher3", PublishDate: "3333", Rating: 5, Status: "ChEEKdIn"}
...
// SetUp function
//
// Sets up test environment with test book models inserted into the database.
...
// @param t - reference to testing.T object
//
// Runs unit test against the CreateBook method for a 200 HTTP Status Request
